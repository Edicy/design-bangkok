...
<ul id="submenu" class="clear"><li{% if item.current? %} class="active"{% endif %}><a href="{{item.url}}">{{item.title}}</a></li>{% for l2 in item.visible_children %}
...
<ul id="submenu" class="clear"><li{% if item.current? %} class="active"{% endif %}><a href="{{item.url}}">{{item.title}}</a></li>{% for l2 in item.children %}
